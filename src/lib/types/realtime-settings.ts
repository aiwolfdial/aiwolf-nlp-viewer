...
export class Convert {
    public static fromJson(json: string): RealtimeSettings {
        return cast(JSON.parse(json), r("RealtimeSettings"));
    }

    public static toJson(value: RealtimeSettings): string {
        return JSON.stringify(uncast(value, r("RealtimeSettings")), null, 2);
    }
}
...
const typeMap: any = {
    ...
    "Agent": o([
        ...
        { json: "team", js: "team", typ: true },
        { json: "role", js: "role", typ: true },
    ], false),
};